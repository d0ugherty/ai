...
class Tester():
    ...
    def finalReport(self):
        ...
        print ("*"*50)
        print ("*"*50)
        print ("*** If you are running grade_program on elvis, ***")
        print ("***   please ignore any messages below this    ***")
        print ("***       point about tests passed or failed!  ***")
        print ("*"*50)
        print ("*"*50)
        print ("\n")
...
# ----------------------- Unigram Tests ----------------------------------------
def unigramTest1():
    unigrams = ngram.computeUnigramProbs(ngramData.UNIGRAM_SAMPLE)
...
def bigramTest4():
    bigrams = ngram.computeBigramProbs(ngramData.BIGRAM_SAMPLE)

    if bigrams == ngramData.BIGRAM_FREQS:
        return("computeBigramProbs Test", True)
    else:
        return("computeBigramProbs Test", False)    
...
def trigramTest4():
    result = False
    try:
        trigrams = ngram.computeTrigramProbs(ngramData.TRIGRAM_SAMPLE)
    ...
    return ("computeTrigramProbs Test", result)
